...
def main():
	...
	if cfg.FaceRec:
		try:
			channels, connection = initializeChannels(logger, ['cvFace'], cfg.IP_ADDRESS_guest)
			(channel_demographics,) = channels
		except Exception as e:
			logger.info('ERROR: failed to init RMQ channel /door signal to guest at: ' + cfg.IP_ADDRESS_guest)
			logger.info('   ' + str(e))
